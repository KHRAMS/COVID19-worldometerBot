        ...
        if(cmd[1].lower() == 'stat'):
            ...
            if(len(cmd) ==3):
                ...
                for i in jsonFile:
                    ...
                    tempbed=discord.Embed(timestamp= datetime.datetime.strptime(i['publishDate'], "%Y-%m-%dT%H:%M:%S"), description=i['title'],author=i['url'], url = i['url'], colour =discord.Colour.blue())
